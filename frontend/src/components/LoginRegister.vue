    ...
    <div class="row" style="margin-top: 300px;">
        <div class="login-reg-panel">
            <div class="login-info-box" v-show="!isLoginChecked">
                ...
                <label id="label-register" for="log-reg-show" style="border-color: white;">Login</label>
            ...
            <div class="register-info-box" v-show="isLoginChecked">
                ...
                <label id="label-login" for="log-login-show" style="border-color: white;">Register</label>
