...
def test_Invalid_get_likes_post(test_client):
    invalit_posts_id = [450,39,None,-9]  # Comprobamos que no hay likes en post que no existen

    for i in invalit_posts_id:
